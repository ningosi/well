...
<div class="ke-panel-frame">
    <div class="ke-panel-heading">Add Item Unit</div>
                        ...
                        <div id="item-details">
                            <div class="card-body">
                                <div class="card-title">
                                    <h3 class="text-center">Item Unit Details</h3>
                                </div>
                                <hr>

                                <form action="${ui.actionLink("wellness", "admin/addInventoryItemUnit", "post")}" method="post" novalidate="novalidate">
